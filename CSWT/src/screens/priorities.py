...
class Ui_Priorities(QtWidgets.QWidget):
    def __init__(self):
        super(Ui_Priorities, self).__init__()
        self.setupUi()
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.title.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Приоритеты</span></p></body></html>"))
