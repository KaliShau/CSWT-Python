...
class Ui_Roles(QtWidgets.QWidget):
    def __init__(self):
        super(Ui_Roles, self).__init__()
        self.setupUi()
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.title.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Роли</span></p><p><br/></p></body></html>"))
