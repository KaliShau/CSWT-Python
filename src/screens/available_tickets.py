...
class Ui_AvailableTickets(QtWidgets.QWidget):
    def __init__(self):
        super(Ui_AvailableTickets, self).__init__()
        self.setupUi()
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.title.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Доступные заявки</span></p></body></html>"))
