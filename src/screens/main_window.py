...
"}")
        ...
        self.myCreateTicketsButton = QtWidgets.QCommandLinkButton(parent=self.workBox)
        self.myCreateTicketsButton.setGeometry(QtCore.QRect(0, 80, 281, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.myCreateTicketsButton.setFont(font)
        self.myCreateTicketsButton.setDescription("")
        self.myCreateTicketsButton.setObjectName("myCreateTicketsButton")
...
"background-color: #202122;}")
        ...
        self.startLabel = QtWidgets.QLabel(parent=self.startWidget)
        self.startLabel.setGeometry(QtCore.QRect(20, 10, 491, 71))
        font = QtGui.QFont()
        font.setBold(False)
        self.startLabel.setFont(font)
        self.startLabel.setStyleSheet("color: #a5a7aa;")
        self.startLabel.setWordWrap(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.myCreateTicketsButton.setText(_translate("MainWindow", "Мои заявки"))
        self.createTicketButton.setText(_translate("MainWindow", "Создать заявку"))
        self.availableTicketsButton.setText(_translate("MainWindow", "Доступные заявок"))
        ...
        self.startLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:400;\">Control System Work Tracker</span></p></body></html>"))
        self.startLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Для получения доступа к функционалу системы нужно зарегистрироваться или войти в систему!</span></p></body></html>"))
