...
class Ui_UpdateRole(QtWidgets.QWidget):
    def __init__(self):
        super(Ui_UpdateRole, self).__init__()
        self.setupUi()
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.title.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Роль:</span></p></body></html>"))
